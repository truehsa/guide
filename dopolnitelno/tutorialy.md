---
description: >-
  Дополнительную информацию по обработке, записи, пресетам и т.д. оставляю в
  этом топике. Если есть предложения по добавлению чего-либо еще, напишите мне!
icon: eyes
---

# Туториалы

## Официальный гайд HLAE

Все туториалы по HLAE есть в официальном гайд-лайне гитхаба этого проекта:

{% embed url="https://github.com/advancedfx/advancedfx/wiki/Tutorials" %}
